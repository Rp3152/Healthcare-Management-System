...
function Profile() {
    ...
    const fetchBasicData = async () => {
        try {
            const response = await axios.get(
                `http://127.0.0.5:3000/user/${id}/profile`,
                {
                    headers: {
    ...
    const postImage = async (file) => {
        ...
        try {
            const response = await axios.put(
                `http://127.0.0.5:3000/user/${id}/icon`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem(
    ...
    function BasicDetails() {
        ...
        const updateBasicDetails = async (values) => {
            ...
            try {
                const response = await axios.put(
                    `http://127.0.0.5:3000/user/${id}/profile/basic-details`,
                    data,
                    {
                        headers: {
                            Authorization: `Bearer ${localStorage.getItem(
    ...
    function PersonalDetails() {
        ...
        const updatePersonalDetails = async (values) => {
            try {
                ...
                const response = await axios.put(
                    `http://127.0.0.5:3000/user/${id}/profile/personal-details`,
                    data,
                    {
                        headers: {
                            Authorization: `Bearer ${localStorage.getItem(
    ...
    return (
        <div className="dashboard-wrapper">
            ...
            <Options profileIcon={profileIcon} isUpdated={isUpdated} />
        </div>
    );
}
